const contentLetterSrart_actived =
  "To my sunshine, though this e-letter isn’t perfect, I did my best to create something you’ll love."; //Lời mở đầu cho bức thư
// const mainContentLetter = "Happy Birthday, Sweetheart! 🎉 Wishing you all the best as you celebrate your 19th birthday. May this year bring you even more beauty and grace, and may you find endless motivation and success on the learning path you have chosen. Keep shining bright and reaching for the stars!"; //Nội dung của bức thư
;

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/capybara_photographer.png";
